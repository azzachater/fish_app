...
final List<Comment> commentsForPost1 = [
  ...
  Comment(
    id: '1',
    user: virgil,
    text: 'Belle prise ! Tu l’as attrapé avec quel type d’appât ? ',
    timestamp: '14:30',
    postId: '0', // ID du post associé
  ),
  Comment(
    id: '2',
    user: angel,
    text: 'Wow, ça doit être un combat impressionnant pour sortir un poisson comme ça ! Félicitations ! 💪',
    timestamp: '14:30',
    postId: '0', // ID du post associé
  ),
];
...
final List<Comment> commentsForPost2 = [
  ...
  Comment(
    id: '4',
    user: nathan,
    text: 'Rien de mieux qu’une journée en mer pour se ressourcer ! Belle aventure ! 🌊☀️',
    timestamp: '14:35',
    postId: '1', // ID du post associé
  ),
];
...
final List<Comment> commentsForPost5 = [
  Comment(
    id: '10',
    user: judd,
    text: 'Jadore voir des nouvelles techniques, merci pour le partage ! 👌',
    timestamp: ' 14:35',
  ...
  Comment(
    id: '11',
    user: leslie,
    text: 'cette technique a lair efficace, je vais tester ça bientôt ! 💡',
    timestamp: ' 14:35',
    postId: '4', // ID du post associé
  ),
];

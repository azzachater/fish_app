...
class MapControllerX extends GetxController {
  ...
  Future<void> initializeMap() async {
    try {
      ...
      Get.snackbar("Erreur", "Échec d'initialisation de la carte: ${e.toString()}");
    }
  }
  ...
  Future<void> moveToCurrentLocation() async {
    try {
      ...
      Get.snackbar("Erreur", "Impossible d'obtenir la position: ${e.toString()}");
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
              ...
              decoration:
                  InputDecoration(labelText: "Espèces de poissons")),
          TextField(
              controller: techniqueController,
              decoration:
                  InputDecoration(labelText: "Techniques recommandées")),
          TextField(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (nameController.text.isEmpty) {
                      Get.snackbar("Erreur", "Le nom du spot est obligatoire");
                      return;
                    }

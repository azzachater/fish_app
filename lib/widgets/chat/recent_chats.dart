    ...
    return Column(
      children: [
        Container(
          ...
          child: Row(
            children: [
              Text('Recent Chats', style: AppTheme.heading2),
              const Spacer(),
            ],
          ),
        ),
        Obx(() {
          ...
          return ListView.builder(
            ...
            itemCount: chatController.recentConversations.length,
            itemBuilder: (context, index) {
              final conversation = chatController.recentConversations[index];
